...
/// <reference path="RefOeService.ts"/>
/// <reference path="../manufacturerTransco/ManufacturerTranscoService"/>
/// <reference path="../manufacturerTransco/IManufacturerTransco"/>
/// <reference path="../manufacturerTransco/IManufacturerReference"/>
/// <reference path="../../../../bower_components/DefinitelyTyped/toastr/toastr.d.ts"/>

module oeup {
    'use strict';

    export interface IRefOeController extends ng.IScope {
        Vm: RefOeController;
    }

    export class RefOeController {

        public Model: IRefOes;
        public File: string;
        public submit: Function;
        public onChange: Function;
        public Vm: IRefOeController;
        public Rules : any;
        public RefOes:Array<IRefOes>;

        constructor($scope: any, $location: ng.ILocationService, $log: ng.ILogService, RefOeService: RefOeService, ManufacturerTranscoService : ManufacturerTranscoService ) {
            var vm = this;
            ...
            var _getManufacturerTransco = function(brand: string) : IManufacturerTransco
            {
           ...
           var _accentsTidy = function(s){
            ...
            var _getManufacturerReference = function(brand: string) : IManufacturerReference
            {
                    ...
                    if(data !== undefined && data !== null) {
                        for(var name in  data) {
                            ...
                            for (var index = 0; index < tab.length; index++) {
                                ...
                                // Regarder OEup.OEUP_ConstructeurTranscoOA.LIBCOU 
                                ...
                                if(!brand) {
                                    ...
                                    // HerNr grace à mon LIBCOU/LIBLong je retrouve celui ci dans OEup.OEUP_TConstructeur
